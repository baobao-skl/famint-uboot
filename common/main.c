...
static __inline__ int isEnterKeyPressed(void)
{
...
#if 0//defined(CONFIG_BOOTDELAY) && (CONFIG_BOOTDELAY >= 0)
	s = getenv ("bootdelay");
...
void FriendlyARMMenu(void)
{
	while(1) {
		int c;
		printf("##### U-Boot(" RELEASE_MARK ", " BOOT_MEDIA ") for 6410 #####\n");
		...
		printf("[p] Download user pref image\n");
